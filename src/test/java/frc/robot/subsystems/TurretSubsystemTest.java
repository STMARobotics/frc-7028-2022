...
public class TurretSubsystemTest {
  ...
  /**
   * Tests the Potentiometer offset constant calculation by testing the value at
   * 180-degrees (straight backwords)
   */
  @Test
  ...
  public void testConvert() {
    assertEquals(-100d, TurretSubsystem.degreesPositionToNativePot(TurretSubsystem.nativePositionToDegrees(-100d)),
        0.1);
  }
